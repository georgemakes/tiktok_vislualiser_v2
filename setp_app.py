...
st.set_page_config(page_title="George's Ad Report Visualiser", layout="wide")
...
def main():
    st.title("George's Ad Report Visualiser")
    ...
    if uploaded_file is not None:
        ...
        if chart_type == "Line Chart":
            ...
            fig = line_chart.create_chart(filtered_data, x_axis, y_axis, group_by)
        ...
        if st.button("Save Chart"):
            ...
            filename = f"charts/tiktok_{chart_type.lower().replace(' ', '_')}_{x_axis}_{y_axis}.html"
